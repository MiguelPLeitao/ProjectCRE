...
```
TypeError: register_page.NAME_InputField.value is not a function
```
...
- generic [ref=e2]:
  ...
  - generic [ref=e4]:
    - generic [ref=e5]:
      - generic [ref=e6]: "Nome:"
      - textbox "Nome:" [ref=e7]: Jovany Bode
    - generic [ref=e8]:
      - generic [ref=e9]: "Email:"
      - textbox "Email:" [ref=e10]: Evalyn.Reilly@yahoo.com
    - generic [ref=e11]:
...
> 72 |             await expect(register_page.NAME_InputField.value()).toBe(undefined);
     |                                                        ^ TypeError: register_page.NAME_InputField.value is not a function
  73 |             await expect(register_page.EMAIL_InputField.value()).toBe(undefined);
  74 |             await expect(register_page.PASSWORD_InputField.value()).toBe(undefined);
  75 |             await expect(register_page.CONFIRM_PASSWORD_InputField.value()).toBe(undefined);
  76 |         }
  77 |     });
  78 | })
```