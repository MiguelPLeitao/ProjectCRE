...
```
TypeError: dashboard_page.TotalLivros_TotalBooks_number.value is not a function
```
...
```ts
  ...
  51 | 
> 52 |         console.log(dashboard_page.TotalLivros_TotalBooks_number.value());
     |                                                                  ^ TypeError: dashboard_page.TotalLivros_TotalBooks_number.value is not a function
  53 |         console.log(dashboard_page.TotalLivrosDisponiveis_TotalBooksAvailable_number.value());
  54 | 
