...
- Location: tests\API_test_suite2_Livros.spec.js:189:5
...
Expected: "Voco acidus curia spiculum cado. Talio arto pariatur suspendo dedecor demulceo. - Editado"
Received: "Voco acidus curia spiculum cado. Talio arto pariatur suspendo dedecor demulceo. - Editada"
```
...
```ts
  ...
  203 |           "descricao": randombook.descricao + " - Editada",
  204 |           "imagemUrl": "",
  205 |           "estoque": 0,
  206 |           "preco": 0
  207 |         }
...
> 218 |     expect(bodyPUTupdateBook.descricao).toBe(randombook.descricao + " - Editado");
      |                                         ^ Error: expect(received).toBe(expected) // Object.is equality
  219 |     expect(bodyPUTupdateBook.imagemUrl).toBe("");
