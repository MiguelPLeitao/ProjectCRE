...
Call log:
  - waiting for getByRole('button', { name: 'Registrar' })
    - locator resolved to <button type="submit">Registrar</button>
...
- generic [ref=e2]:
  ...
  - generic [ref=e4]:
    - generic [ref=e5]:
      - generic [ref=e6]: "Nome:"
      - textbox "Nome:" [ref=e7]: Sophie Hirthe
    - generic [ref=e8]:
      - generic [ref=e9]: "Email:"
      - textbox "Email:" [ref=e10]: Laura_Crooks@yahoo.com
    - generic [ref=e11]:
      - generic [ref=e12]: "Senha:"
      - textbox "Senha:" [ref=e13]: HSAf6DGKpqTrLq1MXb5
    - generic [ref=e14]:
      - generic [ref=e15]: "Confirmar Senha:"
      - textbox "Confirmar Senha:" [active] [ref=e16]: HSAf6DGKpqTrLq1MXb5
