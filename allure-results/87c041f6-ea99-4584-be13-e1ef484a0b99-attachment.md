...
- Name: API_test_suite1_Autenticacao_e_Perfis.spec.js >> Autenticação e Perfis >> Registo com Dados Inválidos (Falha) >> rejeita um email com formato inválido
- Location: tests\API_test_suite1_Autenticacao_e_Perfis.spec.js:107:9
