...
```ts
  ...
  98  | 
  99  |         expect(await books_page.NumeroPaginas_NumberOfPages_spinbutton.evaluate(el => el.validity.valueMissing)).toBe(true);
  100 | 
> 101 |         expect(await books_page.NumeroPaginas_NumberOfPages_spinbutton.evaluate(el => el.validity.RangeOverflow)).toBe(true);
      |                                                                                                                   ^ Error: expect(received).toBe(expected) // Object.is equality
  102 | 
  103 |     });
  104 | 
