...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - generic [ref=e6]: Otis StammALUNO
  ...
  - heading "Olá, Otis Stamm! Você está logado como ALUNO." [level=3] [ref=e16]
...
> 83  |         await expect(dashboard_page.Admin_Usuarios_button).not.toBeVisible();
      |                                                                ^ Error: toBeVisible can be only used with Locator object, was called with undefined
