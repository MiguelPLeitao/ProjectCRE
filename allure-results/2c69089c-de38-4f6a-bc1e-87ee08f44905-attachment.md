...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - generic [ref=e6]: Darnell FlatleyALUNO
  ...
  - generic [ref=e17]:
    - generic [ref=e18]:
      ...
      - combobox "Livro:" [ref=e20]:
        ...
        - option "A Tale of Two Cities (Russell Pfeffer)"
        - option "Blood Meridian (Ms. Lolita Kautzer)" [selected]
    - generic [ref=e21]:
...
> 95  |         page.waitForEvent('dialog').then(async dialog => {
  ...
  106 | 
  107 | 
  108 |         await rents_page.Select_Book_dropdown("random");
