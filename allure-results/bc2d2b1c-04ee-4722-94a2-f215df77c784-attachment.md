...
- Name: tests\API_test_suite.spec.js >> Autenticação e Perfis >> Registo com Dados Inválidos (Falha) >> rejeita um nome numérico
- Location: tests\API_test_suite.spec.js:152:9
