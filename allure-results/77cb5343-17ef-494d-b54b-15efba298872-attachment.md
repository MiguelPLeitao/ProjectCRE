...
```
TypeError: this.SelectLivro_BookCard_grid is not a function
```
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - generic [ref=e6]: Gilbert Volkman-SchillerALUNO
  ...
  - generic [ref=e16] [cursor=pointer]:
    - img "In Cold Blood" [ref=e17]
    - heading "In Cold Blood" [level=3] [ref=e18]
    - paragraph [ref=e19]:
      - strong [ref=e20]: "Autor:"
      - text: Janelle Rodriguez
    - paragraph [ref=e21]:
...
> 88 |         await this.SelectLivro_BookCard_grid(book).click();
     |                    ^ TypeError: this.SelectLivro_BookCard_grid is not a function
  89 |     }
  90 | 
  91 | }
