...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - generic [ref=e6]: Sylvan Okuneva Jr.ALUNO
  ...
  - generic [ref=e16] [cursor=pointer]:
    - img "The Aeneid" [ref=e17]
    - heading "The Aeneid" [level=3] [ref=e18]
    - paragraph [ref=e19]:
...
> 88 |         await this.SelectLivroFavorito_FavouriteBookCard_grid(book).click();
     |                                                                     ^ TypeError: this.SelectLivroFavorito_FavouriteBookCard_grid(...).click is not a function
  89 |     }
  90 | 
  91 | }
  92 | 
  93 | export default Favourites_page;
```