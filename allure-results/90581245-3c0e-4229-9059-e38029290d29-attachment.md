...
Locator: locator('#lista-usuarios').locator('tr').filter({ has: locator('td:nth-child(2) input').filter({ hasText: 'Zander Keebler-Wilkinson' }) })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#lista-usuarios').locator('tr').filter({ has: locator('td:nth-child(2) input').filter({ hasText: 'Zander Keebler-Wilkinson' }) })
