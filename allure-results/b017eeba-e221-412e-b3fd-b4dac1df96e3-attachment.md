...
Call log:
  - waiting for locator('[id="lista-favoritos"] .book-card').filter({ hasText: 'locator(\\\'[id=\\"lista-favoritos\\"] .book-card\\\').filter({ hasText: \\\'Freakonomics\\\' }).first()' }).first()
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - generic [ref=e6]: Amelia LeuschkeALUNO
  ...
  - generic [ref=e16] [cursor=pointer]:
    - img "Freakonomics" [ref=e17]
    - heading "Freakonomics" [level=3] [ref=e18]
    - paragraph [ref=e19]:
      - strong [ref=e20]: "Autor:"
      - text: Kendra Kertzmann
    - paragraph [ref=e21]:
