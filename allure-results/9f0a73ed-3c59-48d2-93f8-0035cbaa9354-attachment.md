...
- Name: API_test_suite1_Autenticacao_e_Perfis.spec.js >> Autenticação e Perfis >> Registo com Dados Inválidos (Falha) >> rejeita um email numérico
- Location: tests\API_test_suite1_Autenticacao_e_Perfis.spec.js:171:9
