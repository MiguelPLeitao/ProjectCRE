...
Call log:
  - waiting for locator('[id="dataFim"]')
    - locator resolved to <input type="date" required="" id="dataFim"/>
    - fill("05/08/2027")
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      - generic [ref=e6]: Scottie HoweALUNO
  ...
  - generic [ref=e17]:
    - generic [ref=e18]:
      ...
      - combobox "Livro:" [ref=e20]:
        ...
        - option "A Handful of Dust (Desiree Wolff DDS)" [selected]
    - generic [ref=e21]:
      - generic [ref=e22]: "Data Início:"
      - textbox "Data Início:" [ref=e23]: 2027-05-23
    - generic [ref=e24]:
      - generic [ref=e25]: "Data Fim:"
      - textbox "Data Fim:" [active] [ref=e26]
