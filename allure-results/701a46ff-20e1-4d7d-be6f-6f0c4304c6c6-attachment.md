...
Call log:
  - waiting for getByRole('textbox', { name: 'Senha:', exact: true })
    - locator resolved to <input id="senha" required="" minlength="6" type="password"/>
    - fill("4VfxS5bX1nDyneS6pE")
...
- generic [ref=e2]:
  ...
  - generic [ref=e4]:
    - generic [ref=e5]:
      - generic [ref=e6]: "Nome:"
      - textbox "Nome:" [ref=e7]: Ayla Boehm-Jerde
    - generic [ref=e8]:
      - generic [ref=e9]: "Email:"
      - textbox "Email:" [active] [ref=e10]: Mark_Sanford@yahoo.com
    - generic [ref=e11]:
