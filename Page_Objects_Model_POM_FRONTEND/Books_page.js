...
class Books_page {
    constructor(page) {
        ...
        this.Livro6_Book6_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(5);
        this.Livro7_Book7_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(6);
        this.Livro8_Book8_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(7);
        this.Livro9_Book9_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(8);
        this.Livro10_Book10_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(9);
        this.Livro11_Book11_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(10);
        this.Livro12_Book12_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(11);
        this.Livro13_Book13_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(12);
        this.Livro14_Book14_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(13);
        this.Livro15_Book15_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(14);
        this.Livro16_Book16_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(15);
        this.Livro17_Book17_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(16);
        this.Livro18_Book18_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(17);
        this.Livro19_Book19_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(18);
        this.Livro20_Book20_button = page.locator("//div[@id='livros-recentes']//div[contains(@class,'book-card')]").nth(19);
