...
- Name: tests\API_test_suite.spec.js >> Autenticação e Perfis >> Registo com Dados Inválidos (Falha) >> rejeita um email com formato inválido
- Location: tests\API_test_suite.spec.js:106:9
