...
- Name: tests\API_test_suite.spec.js >> Autenticação e Perfis >> Registo com Dados Inválidos (Falha) >> rejeita valores nulos
...
> 206 |       expect(responsePOSTmail_Invalid8.status()).toBe(400);
  ...
  208 |       expect(bodyPOSTmail_Invalid8.nome).not.toBe(null);
  209 |       expect(bodyPOSTmail_Invalid8.email).not.toBe(null);
  210 |       expect(bodyPOSTmail_Invalid8.senha).not.toBe(null);
  211 |     });
  212 | 
  213 |   });
  214 | 
